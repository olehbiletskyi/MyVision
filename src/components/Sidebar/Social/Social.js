...
import { SiGmail, SiInstagram, SiSkype, SiWhatsapp, SiMedium, SiViber } from 'react-icons/si';
    ...
    return (
        <div className='Social__wrapper'>
            ...
            <div className="Social">
                ...
                <a href='https://www.viber.com/' className='social-icon viber' target='blank'><SiViber/></a>
